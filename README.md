...
- Of Size... 
  ...
  - 1 option from [Wizard's Gatherer](
    https://gatherer.wizards.com/Pages/Default.aspx) or [product page](
	https://magic.wizards.com/en/products/warofthespark/cards)
  
You can also choose which sets' art to use and even the collector number 
for cards with multiple different images within a set, such as basic lands.
...
1. **PhP version 5.3 or higher, with curl extensions enabled**    
    - _Installing on Windows_   
		...
		[windows PhP website](https://windows.php.net/).
            - Copy the file php.ini-development in C:\PHP7\ and rename it to 
			  php.ini
        ...
        2. Now we must add PhP to the Windows 10 system path enviornmental 
		   variables
            ...
            - In a command prompt type `php -v` to ensure it is working. 
			  You should see version and copyright information.
